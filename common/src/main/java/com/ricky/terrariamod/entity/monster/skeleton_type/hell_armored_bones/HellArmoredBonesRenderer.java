...
public class HellArmoredBonesRenderer extends HumanoidMobRenderer<Skeleton, HumanoidModel<Skeleton>> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("minecraft", "textures/entity/skeleton/skeleton.png");

    public HellArmoredBonesRenderer(EntityRendererProvider.Context context) {
