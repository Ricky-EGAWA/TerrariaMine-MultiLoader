...
public class RaggedCasterRenderer extends HumanoidMobRenderer<Skeleton, HumanoidModel<Skeleton>> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation("minecraft", "textures/entity/skeleton/skeleton.png");

    public RaggedCasterRenderer(EntityRendererProvider.Context context) {
