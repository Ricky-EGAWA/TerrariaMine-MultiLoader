...
public class RaggedCasterArmedRenderer extends HumanoidMobRenderer<Skeleton, HumanoidModel<Skeleton>> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation("minecraft", "textures/entity/skeleton/skeleton.png");

    public RaggedCasterArmedRenderer(EntityRendererProvider.Context context) {
