...
public class SandSlimeEntity extends Slime {
    public SandSlimeEntity(EntityType<? extends Slime> entityType, Level world) {
    ...
    protected void dealDamage(LivingEntity target) {
        ...
        if (target != null) {
            target.addEffect(new MobEffectInstance(MobEffects.HUNGER, 140, 0), this);
        }
    }
}
