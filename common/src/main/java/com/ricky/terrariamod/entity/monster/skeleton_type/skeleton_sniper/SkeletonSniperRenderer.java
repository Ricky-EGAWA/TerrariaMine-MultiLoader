...
public class SkeletonSniperRenderer extends HumanoidMobRenderer<Skeleton, HumanoidModel<Skeleton>> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation("minecraft", "textures/entity/skeleton/skeleton.png");

    public SkeletonSniperRenderer(EntityRendererProvider.Context context) {
