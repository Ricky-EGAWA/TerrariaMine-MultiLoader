...
public class ModPlacedFeaturesUtil {
    ...
    public static List<PlacementModifier> orePlacementBase(PlacementModifier modifier) {
        return List.of(modifier, InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.top()), BiomeFilter.biome());
    }

    public static List<PlacementModifier> orePlacementWithCount(int count, PlacementModifier heightRange) {
        return List.of(CountPlacement.of(count), InSquarePlacement.spread(), heightRange, BiomeFilter.biome());
    }

    public static List<PlacementModifier> orePlacementWithRarity(int rarity, PlacementModifier heightRange) {
        return List.of(RarityFilter.onAverageOnceEvery(rarity), InSquarePlacement.spread(), heightRange, BiomeFilter.biome());
    }

    @SafeVarargs
    public static <FC extends FeatureConfiguration> ResourceKey<PlacedFeature> createOrePlacedFeature(String id, ResourceKey<ConfiguredFeature<?, ?>> feature, PlacementModifier... modifiers) {
    ...
    public static <FC extends FeatureConfiguration> ResourceKey<PlacedFeature> createPlacedFeature(String id, ResourceKey<ConfiguredFeature<?, ?>> feature, Supplier<List<PlacementModifier>> placementModifiers) {
        ResourceLocation bygID = Constants.locate(id);
